...
export function PromoCard({ coupon, onApply }: PromoCardProps) {
  return (
    <Card className="relative overflow-hidden border-brand-100 bg-gradient-to-br from-brand-50 to-white dark:from-brand-500/10 dark:to-transparent">
      <div className="absolute -top-10 -right-8 h-32 w-32 rounded-full bg-brand-200/40 blur-3xl" />
      <CardContent className="relative p-5">
        <div className="flex items-start gap-4">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-500 text-white shadow-sm shadow-brand-500/30 shrink-0">
